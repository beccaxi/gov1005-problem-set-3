...
# While I labeled the columns later on, I first renamed the actual column
# variables themselves to make for easier handling later. 
...
# I call sum() to aggregate the values of the column "treatment"
...
2. Among respondents from the treatment group, the government has an average `r ` rating.
...
3. The most common rating for the government’s handling of traffic is `r `.
...
4. `r ` respondents have given the government a 10 rating overall or on demolitions or on traffic.
...
5. But only `r ` gave the government a 10 rating overall and on demolitions and on traffic.
