...
2. Among respondents from the treatment group, the government has an average `r r2` rating.


```{r Mad Libs 3, include=FALSE}

# I call mode() to find the most common value within the traffic evaluation
# column

r3 <- csv %>%
  summarize(mode(eval_gov_traffic))
```
